...
const stack = [
  ...
  {
    name: "Node.js",
    icon: <SiNodedotjs size={32} className="text-green-700" />,
  },
  {
    name: "Express.js",
    icon: <SiExpress size={32} className="text-gray-800 dark:text-white" />,
  },
  ...
  {
    name: "Socket.io",
    icon: <SiSocketdotio size={32} className="text-gray-600 dark:text-white" />,
  },
  { name: "Stripe", icon: <SiStripe size={32} className="text-indigo-500" /> },
  {
    name: "Firebase",
    icon: <SiFirebase size={32} className="text-orange-500" />,
  },
  {
    name: "Amazon AWS",
    icon: <SiAmazon size={32} className="text-yellow-500" />,
  },
  {
    name: "Cloudflare",
  ...
  {
    name: "Bootstrap",
    icon: <SiBootstrap size={32} className="text-purple-600" />,
  },
