...
export const metadata: Metadata = {
  ...
  description:
    "Request a free, no-obligation quote for your next project. Tell us about your web development, AI integration, or digital marketing needs, and we'll provide a detailed and transparent estimate.",
  keywords: [
    "get a quote",
    "project quote",
