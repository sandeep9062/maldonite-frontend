...
export const metadata: Metadata = {
  ...
  description: "Deep dives on SaaS, SEO, AI, UI/UX, dev tools and startup growth.",
};

async function getBlogs() {
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/v1/blogs`, { cache: 'no-store' });
  if (!res.ok) {
