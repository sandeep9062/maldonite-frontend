      ...
      {show && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-lg bg-[#1e1e1f] text-white rounded-xl shadow-2xl p-4 sm:p-8 mx-2 sm:mx-0"
          >
            {/* Close Button */}
            <button
            ...
            <AnimatePresence mode="wait">
              {submitted ? (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: 20 }}
                  className="mt-4 sm:mt-6 text-center text-white p-3 sm:p-4 rounded-md"
                >
